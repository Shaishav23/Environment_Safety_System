...
<head>
	<title> Environment-Safety System Groups </title>
 ...
 <div class="clear"></div>
		...
		<div id="main" class="shell">
			...
			<br><br>
			        ...
			        <div id="kcontent">
            <h1> Pay On Environment Safety System Zaad Service </h1>
            <div id="wwrapper">
                <div id="steps">
		...
		<!-- End Main -->
			...
			<div class="copy">
				...
				<div class="shell">
					...
					</div>	<p align="center">&copy; Environment Safety System.com. <a href="index.php"><i><font color="fefefe"> Welcome To <strong> Environment Safety System</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
