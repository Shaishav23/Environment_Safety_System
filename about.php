		...
		<div id="main" class="shell">
			...
			<div id="content">
				...
				<div class="post">
					...
					<h2>Developer</h2>
					<img src="images/Dhara.jpeg" alt="Post Image" width="140" height="159" />
					<p>Dhara Sheth </p>
				...
				<div class="post">
					<h2>Developer</h2>
					<img src="images/Shaishav.jpeg" alt="Post Image" width="140" height="159" />
					<p>Shaishav Shah </p>
					<p>. <a href="#" class="more" title="Read More">Read More</a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<div class="post">
					<h2>Developer</h2>
					<img src="images/Priyam.jpeg" alt="Post Image" width="140" height="159" />
					<p>Priyam Shah </p>
					<p>. <a href="#" class="more" title="Read More">Read More</a></p>
					<div class="cl">&nbsp;</div>
				</div>
...
<!-- Begin Sidebar -->
   ...
   <input name="shout_message" id="shout_message" type="text" placeholder="Type Message Hit Enter" maxlength="100" /> 
					...
					</div>	<p align="center">&copy; Environment Safety System.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To <strong> Environment Safety System</strong> Recycled Products Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
