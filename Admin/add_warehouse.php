...
<aside id="sidebar" class="column">
				...
				<!-- End Search -->
		<hr/>
		<h3> Environment Safety System Database Backup:</h3>
		<ul class="toggle">
	...
	<h4 class="alert_info">Welcome To <strong>"Environment Safety System"</strong> Admin Panel As: <?php echo "  ". "<font color='#f90'><big><b>".$login_session."</b></big></font>" ;?>  </h4>
