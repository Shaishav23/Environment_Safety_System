...
$(document).ready(function(){ 
    ...
    // }); 
			...
			<div id="sidebar">
				<div class="col span_1_of_3">
					<div class="contact_info">
    	 				<h2>Find Us Here</h2>
					    	  <div class="map">
							  <div class="mapouter"><div class="gmap_canvas"><iframe width="200" height="200" id="gmap_canvas" src="https://maps.google.com/maps?q=gandhinagar%20Institute%20of%20technology&t=&z=17&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.whatismyip-address.com"></a><br><style>.mapouter{position:relative;text-align:right;height:200px;width:200px;}</style><a href="https://www.embedgooglemap.net">google maps html widget</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:200px;width:200px;}</style></div></div>							  </div>
      				</div>
      			<div class="company_address">
				     	<h2>Company Information :</h2>
						    	<p><big> Environment Safety System</big> Is A Online Sales System Company Established In Gandhinagar Institute Of Technology</p>
						   		<p>  </p>
								<p> Gandhinagar Institute Of Technology</p>
						   		<p>Khatraj-Kalol Road, Moti Bhoyan, Gandhinagar district,</p>
								<p>Kalol, Gujarat 382721</p>
								 <BIG>PHONE</BIG>
				   		          <p>+91-(079)-8155078030</p>
								   <p>+91-(079)-9408000266</p>
								   <p>+91-(079)-9558678768</p>
				   		          <BIG>EMAIL</BIG>
				 	 	          <p>170120116094@git.org.in</p>
								  <p>170120116101@git.org.in</p>
								  <p>170120116092@git.org.in</p>
								   <BIG>FOLLOW US</BIG>
		...
		<div id="footer">
			...
			<div class="copy">
				...
				<div class="shell">
					...
					</div>	<p>&copy; Gandhinagar Institute Of Technology.com.<a href="index.php"><i><font color="fefefe"> Welcome To Environment Safety System</font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
		...
		<!-- <div class="shout_box">
      <div class="header"> live Discussion of Gandhinagar Institute Of Technology <div class="close_btn">&nbsp;</div></div>
